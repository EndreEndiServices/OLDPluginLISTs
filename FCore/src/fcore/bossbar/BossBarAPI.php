...
class BossBarAPI{
    ...
    public static function setPercentage(int $percentage, int $eid, $players = []){
        ...
        $upk->entries[] = new BossBarAttributes(1, 600, max(1, min([$percentage, 100])) / 100 * 600, 'minecraft:health'); // Ensures that the number is between 1 and 100; //Blame mojang, Ender Dragon seems to die on health 1
