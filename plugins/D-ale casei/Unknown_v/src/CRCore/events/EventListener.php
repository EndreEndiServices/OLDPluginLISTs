...
class EventListener implements Listener{
    ...
    public function onJoin(PlayerJoinEvent $event) : void{
        ...
        $player->addTitle(TextFormat::GREEN . TextFormat::BOLD . "§5ILOVEMCPE §cServers §6Network §bCommunity", TextFormat::GOLD . "§eServer Romanesc");
        $player->sendPopup(TextFormat::GREEN . "§eBine ai venit pe §5ILOVEMCPE\n" . TextFormat::GRAY . "§eBine ai venit pe §5ILOVEMCPE §cServers §6Network §bCommunity §bDistractie §cplacuta§7!");
        $player->sendMessage(TextFormat::GREEN . "                     99-=§5ILOVEMCPE§9=-              ");
        $player->sendMessage(TextFormat::GRAY . "                                             ");
        $player->sendMessage(TextFormat::GRAY . "   A Kingdoms Minecraft Bedrock Edition Server");
        $player->sendMessage(TextFormat::BOLD . TextFormat::AQUA . "   VOTEAZA:" . TextFormat::GRAY . " http://bit.do/ilVOTE");
        $player->sendMessage(TextFormat::BOLD . TextFormat::AQUA . "   Scrie:" . TextFormat::GRAY . " /report daca vezi un hacker,sau pe cineva care abuzeaza de buguri.");
        $player->sendMessage(TextFormat::BOLD . TextFormat::AQUA . "   Vrei sa sti preturile sau rank-urile?:" . TextFormat::GRAY . " /donez");
        $player->sendMessage(TextFormat::GRAY . "                                             ");
        ...
        if($event->getItem()->getId() === 130){
            ...
            switch($damage){
                case 101:
                    ...
                    $player->addTitle(TextFormat::BOLD . TextFormat::DARK_GRAY . "(" . TextFormat::GREEN . "!" . TextFormat::DARK_GRAY . ") " . TextFormat::RESET . TextFormat::GRAY . "Ai castigat!:", TextFormat::BOLD . TextFormat::LIGHT_PURPLE . "$" . $tier1win);
                ...
                case 102:
                    ...
                    $player->addTitle(TextFormat::BOLD . TextFormat::DARK_GRAY . "(" . TextFormat::GREEN . "!" . TextFormat::DARK_GRAY . ") " . TextFormat::RESET . TextFormat::GRAY . "Ai castigat!:", TextFormat::BOLD . TextFormat::LIGHT_PURPLE . "$" . $tier2win);
                ...
                case 103:
                    ...
                    $player->addTitle(TextFormat::BOLD . TextFormat::DARK_GRAY . "(" . TextFormat::GREEN . "!" . TextFormat::DARK_GRAY . ") " . TextFormat::RESET . TextFormat::GRAY . "Ai castigat!:", TextFormat::BOLD . TextFormat::LIGHT_PURPLE . "$" . $tier3win);
