...
public class FishingHook extends EntityProjectile {
    ...
    /*public boolean getGirl(Object girl){
        int tries = 0;
        ...
        String[] negatives = new String[]{"nevím", "ne", "já bych s tím počkala", "myslím že bychom si nerozumněli", ""};

        while(!my){
            girl.ask("Chtěla by jsi se mnou chodit?");

            String result = girl.receive();
            ...
            if(!result.contains("miluj")){
                ...
                Thread.sleep(86400 * 1000); //one day
            } else {
                my = true;
            }
        }
