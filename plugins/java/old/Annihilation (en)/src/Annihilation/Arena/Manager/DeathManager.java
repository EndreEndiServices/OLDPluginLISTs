        ...
        if (lastDmg != null) {
            if (lastDmg instanceof EntityDamageByChildEntityEvent) {
                ...
                if (arrow instanceof EntityProjectile) {
                    ...
                    new NormalQuery(Annihilation.getInstance(), Stat.KILLS, new String[]{killer.getName().toLowerCase()});
            ...
            if (escape) {
                new NormalQuery(Annihilation.getInstance(), Stat.KILLS, new String[]{killer.toLowerCase()});
