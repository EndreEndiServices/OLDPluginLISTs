...
public class HumanInventory extends BaseInventory {
    ...
    public HumanInventory(AnnihilationNPC player) {
    ...
    public void onSlotChange(int index, Item before) {
        AnnihilationNPC holder = this.getHolder();
    ...
    @Override
    public AnnihilationNPC getHolder() {
        return (AnnihilationNPC) super.getHolder();
    }
}
