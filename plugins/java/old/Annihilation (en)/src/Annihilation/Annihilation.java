...
import MTCore.Task.MessageTask;
...
public class Annihilation extends PluginBase implements Listener {
    ...
    public void onHit(EntityDamageByEntityEvent e) {
        ...
        if (item.getId() == Item.GOLD_INGOT) {
            new BuyKitQuery(this, p.getName().toLowerCase(), kit, BuyKitQuery.ACTION_BUY);
        } else {
            new BuyKitQuery(this, p.getName().toLowerCase(), kit, BuyKitQuery.ACTION_INFO);
