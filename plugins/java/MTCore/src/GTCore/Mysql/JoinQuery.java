    ...
    public void onRun() {
        ...
        if (!getApi().isRegistered(getPlayer())) {
            joinMsg = TextFormat.GRAY + "==========================================" + "\n" +
                    TextFormat.YELLOW + ">> Vítej na serveru " + MTCore.getPrefix() + TextFormat.WHITE + ", " + displayName + "\n" +
                    TextFormat.YELLOW + ">> Tento ucet jeste neni zaregistrovany\n" +
                    TextFormat.YELLOW + ">> Muzes se zaregistrovat prikazem " + TextFormat.RED + "/register\n" +
                    TextFormat.GRAY + "==========================================";
        } else {
            joinMsg = TextFormat.GRAY + "==========================================" + "\n" +
                    TextFormat.YELLOW + ">> Vítej na serveru " + MTCore.getPrefix() + TextFormat.WHITE + ", " + displayName + "\n" +
                    TextFormat.YELLOW + ">> Tento ucet je jiz registrovany" + "\n" +
                    TextFormat.YELLOW + ">> Muzes se prihlasit prikazem " + TextFormat.RED + "/login " + TextFormat.YELLOW + "nebo si muzes zmenit" + "\n" +
                    TextFormat.YELLOW + ">> svuj nick v nastaveni MCPE." + "\n" +
                    TextFormat.GRAY + "==========================================";
        }
