    ...
    public void onQuery(HashMap<String, Object> data) {
        ...
        if (!isOp && data == null && !senderData.get("rank").equals("banner")) {
            ...
            if ($id != null) {
                ...
                $result["msg"] = GTCore.getPrefix() + TextFormat::GREEN . "banned player " . TextFormat::YELLOW . $this->player;
                $result["success"] = true;
            } else {
                $result["msg"] = GTCore.getPrefix() + TextFormat.RED + "can not ban this player";
            }
        }
        ...
        /*if($banData != null){
            ...
            $data =
                [
                    "name" => $name,
                    "reason" => $reason,
                    "expiration" => GTCore::getTime() + 1209600,
                    "forever" => 0,
                    "amount" => 1
                ];
