...
class PvPManager implements Listener {
    ...
    public function teleportToPVP(Player $player) {
        ...
        BossBarAPI::setTitle("§7WELCOME ON §6PLAY.FACTIONPE.TK §7{$player->getName()} §f|| §7CHECK OUR WEBSITE §6FACTIONPE.TK\n\n".str_repeat(" ", 30)."§aYou are playing on PVP #1", $this->plugin->barEid, [$player]);
    }
