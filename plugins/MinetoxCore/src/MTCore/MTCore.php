...
class MTCore extends PluginBase implements Listener{
    ...
    public function onEnable() {
        ...
        $this->getScheduler()->scheduleRepeatingTask(new MessageTask($this), 2400);
        $this->getScheduler()->scheduleDelayedTask(new LoadPluginTask($this), 5);

        $this->getLogger()->info(self::getPrefix()."§r§aENABLED!");
    }
