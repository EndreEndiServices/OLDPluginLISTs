...
class Central extends PluginBase{
	...
	const BRAND_PREFIX = TextFormat::RESET.TextFormat::DARK_GRAY.TextFormat::BOLD."[".TextFormat::RESET.TextFormat::BLUE."Paradox UHC".TextFormat::DARK_GRAY.TextFormat::BOLD."]".TextFormat::RESET;
	const TWITTER = TextFormat::BLUE."@ParadoxTwitUHC";
