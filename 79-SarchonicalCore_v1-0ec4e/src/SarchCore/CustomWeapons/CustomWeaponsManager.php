...
class CustomWeaponsManager implements Listener {
	...
	public function __construct(SarchCore $plugin) {
		...
		$galadhrim->addEnchantment(Enchantment::getEnchantment(Enchantment::INFINITY));// 22
		...
		$ench = Enchantment::getEnchantment(Enchantment::SHARPNESS);
		$ench->setLevel(2);
		$stt->addEnchantment($ench);
		$ench = Enchantment::getEnchantment(Enchantment::ARTHROPODS);
		$ench->setLevel(3);
		$stt->addEnchantment($ench);
		$ench = Enchantment::getEnchantment(Enchantment::LOOTING);
		$ench->setLevel(2);
		$stt->addEnchantment($ench);
		...
		$ench = Enchantment::getEnchantment(Enchantment::SMITE);
		$ench->setLevel(4);
		...
		$ench->setLevel(5);
		$zaxe->addEnchantment($ench);
		$ench = Enchantment::getEnchantment(Enchantment::SILK_TOUCH);
		$ench->setLevel(1);
		$zaxe->addEnchantment($ench);
		...
		$ench = Enchantment::getEnchantment(Enchantment::PROTECTION);
		$ench->setLevel(2);
		$heavyhelm->addEnchantment($ench);
		$ench = Enchantment::getEnchantment(Enchantment::BLAST_PROTECTION);
		$ench->setLevel(4);
		$heavyhelm->addEnchantment($ench);
		$ench = Enchantment::getEnchantment(Enchantment::PROJECTILE_PROTECTION);
		$ench->setLevel(4);
		$heavyhelm->addEnchantment($ench);
		$ench = Enchantment::getEnchantment(Enchantment::THORNS);
		$ench->setLevel(2);
		$heavyhelm->addEnchantment($ench);
		...
		$ench = Enchantment::getEnchantment(Enchantment::FALL_PROTECTION);
		$ench->setLevel(1);
		$heavyboot->addEnchantment($ench);
		$ench = Enchantment::getEnchantment(Enchantment::PROJECTILE_PROTECTION);
		$ench->setLevel(3);
		...
		$ench = Enchantment::getEnchantment(Enchantment::FIRE_PROTECTION);
		$ench->setLevel(4);
		$heavychest->addEnchantment($ench);
		$ench = Enchantment::getEnchantment(Enchantment::BLAST_PROTECTION);
		$ench->setLevel(3);
