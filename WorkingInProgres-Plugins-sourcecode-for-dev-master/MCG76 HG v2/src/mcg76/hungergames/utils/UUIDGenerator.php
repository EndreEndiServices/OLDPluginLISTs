...
class UUIDGenerator{
	...
	public function equals(UUIDGenerator $uuid){
	...
	public static function fromBinary($uuid, $version = null){
		...
		return new UUIDGenerator(Binary::readInt(substr($uuid, 0, 4)), Binary::readInt(substr($uuid, 4, 4)), Binary::readInt(substr($uuid, 8, 4)), Binary::readInt(substr($uuid, 12, 4)), $version);
	}
