...
class UHC extends P implements L
{
    ...
    public $killer;
    public $deathpos = [];
    public $prefix = TF::DARK_GRAY."[".TF::DARK_RED."Adrenaline".TF::GOLD."UHC".TF::DARK_GRAY."]".TF::RESET;
    ...
    public function onDeath(Death $event)
    {
        ...
        if($cause instanceof EntityDamageByEntityEvent){
            ...
            if($killer instanceof Player){
                ...
                if($this->getLanguage($killer) == "english"){
                    $killer->sendMessage(TF::DARK_GRAY."[".TF::DARK_RED."Adrenaline".TF::GOLD."UHC".TF::DARK_GRAY."]".TF::RESET.TF::GRAY.' A kill has been added to your stats!');
                }
                if($this->getLanguage($killer) == "spanish"){
                    $killer->sendMessage(TF::DARK_GRAY."[".TF::DARK_RED."Adrenaline".TF::GOLD."UHC".TF::DARK_GRAY."]".TF::RESET.TF::GRAY.' Una matanza ha sido agregado a sus estadísticas!');
                }
        ...
        if ($player->hasPermission("uhc.perms.spectate")) {
            ...
            if($this->getLanguage($player) == "english"){
                $player->sendMessage(TF::DARK_GRAY."[".TF::DARK_RED."Adrenaline".TF::GOLD."UHC".TF::DARK_GRAY."]".TF::RESET.TF::GRAY." You have died! Use /spectate [name] to spectate a player!");
            }
            if($this->getLanguage($player) == "spanish"){
                $player->sendMessage(TF::DARK_GRAY."[".TF::DARK_RED."Adrenaline".TF::GOLD."UHC".TF::DARK_GRAY."]".TF::RESET.TF::GRAY." ¡Te has muerto! Uso /spectate [nombre] spectate un jugador!");
            }
        }
        if ($this->scenarioIsOn("diamondless")) {
        ...
        if(!($player->hasPermission("uhc.perms.spectate"))){
            ...
            if($this->getLanguage($player) == "english"){
                $player->sendMessage(TF::DARK_GRAY."[".TF::DARK_RED."Adrenaline".TF::GOLD."UHC".TF::DARK_GRAY."]".TF::RESET.TF::GRAY." You have 30 seconds to say your final words before getting kicked and unwhitelisted!");
            }
            if($this->getLanguage($player) == "spanish"){
                $player->sendMessage(TF::DARK_GRAY."[".TF::DARK_RED."Adrenaline".TF::GOLD."UHC".TF::DARK_GRAY."]".TF::RESET.TF::GRAY." Tienes 30 segundos para decir sus últimas palabras antes de ser expulsado y unwhitelisted!");
            }
        }
    }
    ...
    public function onDamage(Damage $event){
        ...
        if($cause == Damage::CAUSE_FALL){
            switch($e){
				...
				case self::STATUS_TP_1:
				case self::STATUS_TELE_1:
				case self::STATUS_LAST:
                    $event->setCancelled();
