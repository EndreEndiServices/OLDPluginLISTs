            ...
            if (isset($args[0])) {
                ...
                if(!$player) {
                    $this->player = new Config($this->plugin->getDataFolder()."players/".strtolower($offlineplayer->getName()).".yml", Config::YAML);
                        ...
                        $sender->sendMessage(TF::GRAY . 'Kills:' . TF::BLUE . $this->player->get("Kills"));
                        $sender->sendMessage(TF::GRAY . 'Deaths:' . TF::BLUE . $this->player->get("Deaths"));
                        $sender->sendMessage(TF::GRAY . 'UHCs:' . TF::BLUE . $this->player->get("UHCs"));
                        $sender->sendMessage(TF::GRAY . 'Wins:' . TF::BLUE . $this->player->get("Wins"));
                        $sender->sendMessage(TF::GRAY . 'Diamonds Mined:' . TF::BLUE . $this->player->get("Diamonds"));
                        $sender->sendMessage(TF::GRAY . 'Amount of Heads Eaten:' . TF::BLUE . $this->player->get("Heads"));
