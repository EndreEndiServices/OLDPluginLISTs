        ...
        if($sender->hasPermission("uhc.perms.gm")){
            if(isset($args[0])){
                if($args[0] === "on"){
                    ...
                    $this->plugin->getServer()->broadcastMessage(TF::DARK_GRAY.'['.TF::DARK_RED."Adrenaline".TF::GOLD."UHC".TF::DARK_GRAY.']'.TF::RESET.TF::GRAY.' Global mute has been enabled by an admin!');
                }
                if($args[0] === "off"){
                    ...
                    $this->plugin->config->save();
                    $this->plugin->getServer()->broadcastMessage(TF::DARK_GRAY.'['.TF::DARK_RED."Adrenaline".TF::GOLD."UHC".TF::DARK_GRAY.']'.TF::RESET.TF::GRAY.' Global mute has been disabled by an admin!');
                }
            }
        }
    }
