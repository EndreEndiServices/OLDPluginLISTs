       ...
       public function onCommand(CommandSender $p, Command $c, $label, array $args){
       	if($c == "kit"){
              if($this->kit[$p->getName()] == 1){
                 ...
                 $kamen = Item::get(1,0,160);
                 $p->getInventory()->addItem($kamen);
                 ...
                 $wood = Item::get(17,0,128);
                 $p->getInventory()->addItem($wood);
                 
                 $tooth = Item::get(50,0,45);
                 $p->getInventory()->addItem($tooth);
                 
                 $glass = Item::get(20,0,50);
                 $p->getInventory()->addItem($glass);

                 $magma = Item::get(378,0,1);
                 $magma->setCustomName("§dМагия");
                 $p->getInventory()->addItem($magma);
                 
                 $prowerka = Item::get(341,0,1);
                 $prowerka->setCustomName("§dМагия");
                 ...
                 $p->sendMessage("§cBomba§bCraft§8)§f Вы уже брали этот набор!");
                 $p->sendMessage("§cBomba§bCraft§8)§f После смерти вы снова §bсможете§f взять этот набор.");
            }
       }
