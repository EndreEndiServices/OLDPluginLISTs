...
class Api extends PluginBase implements Listener
{
	...
	public function broadcaster(){
		$msg = array(
		"\n(§cУведомление§f) Купи привилегию на сайте§6 §dPay.MysteryBox.ru! \n(§cВнимание§f) И сможешь приватить больше територий Огромного размера\n",
		...
		"Хочешь §aвыделиться§f? Купи себе §eдонат §fна сайте §bPay.MysteryBox.ru",
		"Вводи §e/hack§f, каждый рестарт сервера, чтобы выбить §cАдминку§f!",
		"Хотите, чтобы сервер работал §3вечно§f? Приобретайте услуги: §ePay.MysteryBox.ru"
		);
