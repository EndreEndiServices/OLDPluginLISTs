        ...
        switch($cmd->getName())
		{
            case 'tpa':
                if ($sender instanceof Player)
                {
                    if((count($args) != 0) && (count($args) < 2))
                    {
                        ...
                        {
							$sender->sendMessage("§8(§aТелепорт§8)§f Ты §aотправил §fзапрос на телепортацию!");
                            $this->getServer()->getPlayer($args[0])->sendMessage("§8(§aТелепорт§8)§f Игрок ".F::AQUA.$this->tp_sender.F::WHITE." отправил(а) запрос на телепортацию к тебе");
                            $this->getServer()->getPlayer($args[0])->sendMessage("§8(§aТелепорт§8)§f Напиши: ".F::AQUA."/tpaccept".F::WHITE." или ".F::AQUA."/tpc".F::WHITE.", чтобы принять запрос");
                        ...
                        {
                            $sender->sendMessage("§8(§aТелепорт§8)§c Игрок не онлайн или ты ввел(а) неверный ник.");
                            return true;
                        }
                    }
                    else
                    {
                        $sender->sendMessage("§8(§aТелепорт§8)§f Используй: ".F::AQUA."/tpa <ник>");
                        return false;
                    }
                }
                else
			...
			case 'tpc':
                if ($sender instanceof Player)
                {
                    ...
                    if(count($sql) > 0)
                    {
                      ...
                      switch($sql['type'])
                      {
                          case 'tpa':
                              ...
                              {
								  $sender->sendMessage("§8(§aТелепорт§8)§f Ты принял запрос на телепортацию, от игрока ".F::AQUA.$this->getServer()->getPlayer($sql['player_from'])->getName());
								  $this->getServer()->getPlayer($sql['player_from'])->sendMessage("§8(§aТелепорт§8)§f Игрок принял твой запрос. ".F::AQUA."Телепортация..");
                    ...
                    {
                        $sender->sendMessage("§8(§aТелепорт§8)§f У вас нет §cактивных §fзапросов");
